...
import { searchGroceryStores, searchProducts, getGeolocation, createGroceryOrder, findStoresForShoppingList,
    ...
    searchCart, processStoreInventory, createAddress, getAddresses, deletePaymentMethod } from '../controllers/GroceryController';
...
router.post('/payment-methods/delete', deletePaymentMethod);
